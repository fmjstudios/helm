...
```shell
helm install my-release oci://ghcr.io/fmjstudios/helm/linkstack:1.2.3
```
...
| `ingress.extraHosts`  | A list of extra hosts for the Ingress resource (with linkstack.http(s)ServerName) | `[]`    |
